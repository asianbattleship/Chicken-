...
export default class Nonagon extends AbstractShape {
    ...
    protected static BASE_ROTATION = AbstractShape.BASE_ROTATION / 2.5;
    protected static BASE_ORBIT = AbstractShape.BASE_ORBIT / 10;
    protected static BASE_VELOCITY = AbstractShape.BASE_VELOCITY / 3.5;
    ...
    public constructor(game: GameServer, isAlpha=false, shiny=(Math.random() < 0.000001) && !isAlpha) {
        ...
        this.styleData.values.color = shiny ? Color.Shiny : Color.TeamYellow;
